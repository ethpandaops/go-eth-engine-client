...
// GetPayloadResponse is the response from engine_getPayloadV5. It
// corresponds to the SSZ container `GetPayloadResponseV5`: V4 with the
// BlobsBundle upgraded to V2 (cell proofs).
