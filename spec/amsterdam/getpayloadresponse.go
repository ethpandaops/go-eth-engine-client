...
// GetPayloadResponse is the response from engine_getPayloadV6. It
// corresponds to the SSZ container `GetPayloadResponseV6`: V5 with the
// execution payload upgraded to V4.
type GetPayloadResponse struct {
	ExecutionPayload      *ExecutionPayload         `json:"executionPayload"`
	BlockValue            *uint256.Int              `ssz-type:"uint256" json:"blockValue"`
	BlobsBundle           *osaka.BlobsBundle        `json:"blobsBundle"`
	ShouldOverrideBuilder bool                      `json:"shouldOverrideBuilder"`
	ExecutionRequests     []prague.ExecutionRequest `dynssz-max:"MAX_EXECUTION_REQUESTS,MAX_BYTES_PER_TRANSACTION" ssz-max:"256,1073741824" ssz-size:"?,?" json:"executionRequests"`
}
...
type getPayloadResponseJSON struct {
	...
	BlobsBundle           *osaka.BlobsBundle        `json:"blobsBundle"`
	ShouldOverrideBuilder bool                      `json:"shouldOverrideBuilder"`
	ExecutionRequests     []prague.ExecutionRequest `json:"executionRequests"`
}
