...
// ExecutionPayload is the payload structure exchanged by engine_newPayloadV3
// and engine_getPayloadV3's response. It corresponds to the SSZ container
// `ExecutionPayloadV3` — `ExecutionPayloadV2` extended with `blobGasUsed`
// and `excessBlobGas`.
