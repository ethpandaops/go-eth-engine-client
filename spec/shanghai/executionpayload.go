...
// ExecutionPayload is the payload structure exchanged by engine_newPayloadV2
// and engine_getPayloadV2's response. It corresponds to the SSZ container
// `ExecutionPayloadV2` — `ExecutionPayloadV1` extended with a withdrawals
// list.
